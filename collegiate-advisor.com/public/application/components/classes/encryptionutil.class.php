...
/******************************************
 * Example Usage for Collegiate Advisors
 ******************************************/
/*

$pass = "Ue3(nE76Nidk#2!tB9KiN^gfDCv39kUz";
$salt = "m*(2lk3nAS#kas93jAasd9)njAdke9Lk";
$msg  = "mikedflynn@gmail.com";

$key = EncryptionUtil::pbkdf2($pass,$salt,2951,32);
$encrypted = EncryptionUtil::encrypt($msg,$key);
...
class EncryptionUtil {
	...
	*/
	public static function encrypt( $msg, $k, $base64 = true ) {
		...
		$mac  = EncryptionUtil::pbkdf2($msg, $k, 1000, 32);		# create mac
		$msg .= $mac;									# append mac
	...
	*/
	public static function decrypt( $msg, $k, $base64 = true ) {
		...
		$mac = EncryptionUtil::pbkdf2($iv . $msg, $k, 1000, 32);		# create mac
