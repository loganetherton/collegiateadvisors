...
//--------------------------------------------------------------------------
// Name: LW_Form_Element_Radio
// Desc: Manages a single radio element.
//--------------------------------------------------------------------------
class LW_Form_Element_Radio extends LW_Form_Element
{

			//------------------------------------------------------------------------
			// Public Variables
			//------------------------------------------------------------------------
			public $type = LW_Form_Element::TYPE_RADIO;
			...
			//------------------------------------------------------------------------
			public function __construct( $id, $name = '', $label = ' ', $element_value = '',
			...
			public function display( &$html, $template = false )
			{
						...
						if ( $backtrace[1]['class'] != 'LW_Form_Group' )
						{
									...
									if ( $this->rules['required'] )
												$element_html .= '<label for="' . $this->id . '"><em>' . $this->label .
															'</em></label>';
									else
						...
						$element_html .= '<input type="radio" class="radio" id="' . $this->id .
									'" name="' . $this->name . '" value="' . $this->element_value . '" ';
